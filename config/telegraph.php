...
use App\Telegram\Handlers\WorkerBotHandler;
...
return [
    ...
    'webhook' => [
         ...
         */
        'handler' => WorkerBotHandler::class,
    ...
    'security' => [
         ...
         * Kerak, chunki har bir yangi ishchi botga /start bosganda hali
         * bizning telegraph_chats jadvalimizda mavjud emas.
         */
